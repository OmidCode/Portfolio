        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-2xl font-bold text-white tracking-wider">Integragration of web app with animation using html/css</span>
          ...
          {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${HotTakesImg})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://github.com/OmidCode/Piiquante-P6" target="_blank" rel="noopener noreferrer">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">Code</button>
                </a>
              </div>
            </div>
